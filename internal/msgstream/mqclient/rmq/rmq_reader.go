...
var _ mqclient.Reader = (*rmqReader)(nil)
...
func (rr *rmqReader) Next(ctx context.Context) (mqclient.Message, error) {
...
func (rr *rmqReader) Seek(id mqclient.MessageID) error {
