...
func (pc *PulsarConsumer) Chan() <-chan mqclient.Message {
	if pc.msgChannel == nil {
		pc.once.Do(func() {
			pc.msgChannel = make(chan mqclient.Message, 256)
...
func (pc *PulsarConsumer) Seek(id mqclient.MessageID, inclusive bool) error {
...
func (pc *PulsarConsumer) Ack(message mqclient.Message) {
