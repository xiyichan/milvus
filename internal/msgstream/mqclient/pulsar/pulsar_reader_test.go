...
func TestPulsarReader(t *testing.T) {
	...
	reader, err := pc.CreateReader(mqclient.ReaderOptions{
		Topic:          topic,
	...
	readerOfStartMessageID, err := pc.CreateReader(mqclient.ReaderOptions{
		Topic:                   topic,
	...
	readerOfSeek, err := pc.CreateReader(mqclient.ReaderOptions{
		Topic:          topic,
		StartMessageID: pc.EarliestMessageID(),
	})
	assert.Nil(t, err)
