...
func (pc *pulsarClient) CreateProducer(options mqclient.ProducerOptions) (mqclient.Producer, error) {
...
func (pc *pulsarClient) CreateReader(options mqclient.ReaderOptions) (mqclient.Reader, error) {
...
func (pc *pulsarClient) Subscribe(options mqclient.ConsumerOptions) (mqclient.Consumer, error) {
	...
	if options.SubscriptionInitialPosition == mqclient.SubscriptionPositionLatest {
...
func (pc *pulsarClient) EarliestMessageID() mqclient.MessageID {
	msgID := pulsar.EarliestMessageID()
	return &pulsarID{messageID: msgID}
}

// StringToMsgID converts the string id to MessageID type
func (pc *pulsarClient) StringToMsgID(id string) (mqclient.MessageID, error) {
...
func (pc *pulsarClient) BytesToMsgID(id []byte) (mqclient.MessageID, error) {
